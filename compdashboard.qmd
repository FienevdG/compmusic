...
Punk rock as a genre is known for its music that returnes to the basics: it’s short, fast, loud and simple. 
As some people might say; “anyone who could hold an instrument, could make punk”. 
That idea of accessibility was a very big part of the punk movement. The movement as a whole was very DIY: start your own band, make your own clothes, do your own thing. Punk rebells against the commercialization of rock’n’roll. 
...
My question for this portfolio is: Is there computational evidence for this difference or is the differnce more cultural than it is musical? 
...
These playlists contain all the most influential bands and songs in the respective subgenres.

<iframe
  style="border-radius:12px"
  src="https://open.spotify.com/embed/playlist/03PwoyMpiDWtMsHRN5d8V3?utm_source=generator&si=45f8bc40aefe436e"
  width="100%"
  height="200"
  frameborder="0"
  allowfullscreen
...
On this page I used MFCC Self Similarty Matrices (SSMs). These matrices compare a song to itself, so every moment is compared to every moment in a song. High similartity will show up as bright, yellow blocks. Dissimilarity will show up as dark blue blocks. 
...
The bright yellow diagonal line trough both SSMs is the point where the tracks cross themselves and thus exactly overlap.
